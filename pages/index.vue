      ...
      <section class="landing-hero pt-5 px-10">
        ...
        <div class="container mx-auto relative">
          ...
          <div class="flex items-center pt-10 px-5 md:px-0">
            <div class="w-1/2">
              <h1 class="text-4xl text-red mb-5">
        ...
        <div class="flex mt-3 -mx-6">
          ...
          >
            <div class="item">
              <figure class="item-image">
                <img
                  src="/images/project-thumbnail-2.jpg"
                  alt=""
                  class="rounded-20 w-full"
                />
              </figure>
          ...
          >
            <div class="item">
              <figure class="item-image">
                <img
                  src="/images/project-thumbnail-3.jpg"
                  alt=""
                  class="rounded-20 w-full"
                />
              </figure>
        ...
        <div class="flex mt-3 -mx-6">
          ...
          >
            <div class="item">
              <figure class="item-image">
                <img
                  src="/images/project-thumbnail-4.jpg"
                  alt=""
                  class="rounded-20 w-full"
                />
              </figure>
          ...
          >
            <div class="item">
              <figure class="item-image">
                <img
                  src="/images/project-thumbnail-5.jpg"
                  alt=""
                  class="rounded-20 w-full"
                />
              </figure>
          ...
          >
            <div class="item">
              <figure class="item-image">
                <img
                  src="/images/project-thumbnail-6.jpg"
                  alt=""
                  class="rounded-20 w-full"
                />
              </figure>
