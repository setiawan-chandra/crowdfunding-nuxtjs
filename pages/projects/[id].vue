            ...
            <div class="flex mt-3">
                <div class="w-3/4 mr-6">
                    <div class="bg-white p-3 mb-3 border border-gray-400 rounded-20">
                        <figure class="item-image">
                            <img src="/images/project-image.jpg" alt="" class="rounded-20 w-full" />
                        </figure>
                    </div>
                    <div class="flex -mx-2">
                        <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
                            <figure class="item-thumbnail">
                                <img src="/images/project-slider-1.jpg" alt="" class="rounded-20 w-full" />
                            </figure>
                        </div>
                        <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
                            <figure class="item-thumbnail">
                                <img src="/images/project-slider-2.jpg" alt="" class="rounded-20 w-full" />
                            </figure>
                        </div>
                        <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
                            <figure class="item-thumbnail">
                                <img src="/images/project-slider-3.jpg" alt="" class="rounded-20 w-full" />
                            </figure>
                        </div>
                        <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
                            <figure class="item-thumbnail">
                                <img src="/images/project-slider-4.jpg" alt="" class="rounded-20 w-full" />
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="w-1/4">
                    <div class="bg-white w-full p-5 border border-gray-400 rounded-20 sticky" style="top: 15px">
                        ...
                        <div class="flex mt-3">
                            <div class="w-1/4">
                                <img src="/images/testimonial-1-icon.png" alt="" class="w-full inline-block rounded-full" />
                            </div>
